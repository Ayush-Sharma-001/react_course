...
//                             // onCurrencyChange={(currency) => setAmount(currency)} // amount to currency changed
//                             onCurrencyChange={(currency) => setFrom(currency)} // amount to currency changed
//                             selectCurrency={from}
...
//                         <button
//                             type="button"
//                             className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-4 border-white rounded-lg bg-blue-600 text-white px-4 py-0.5"
//                             onClick={swap}
//                         >
//                             swap
//                         </button>
...
function App() {
    ...
    const swap = () => {
        ...
        setFrom(to);
        setTo(from);
        // Swapping amounts as well
        setAmount(convertedAmount); // Use the converted amount as the new input amount
        setConvertedAmount(amount); // Use the input amount as the new converted amount
    };
